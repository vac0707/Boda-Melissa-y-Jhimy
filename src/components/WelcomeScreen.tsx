          ...
          <>
            ...
            >
              ...
              {phase === "initial" && (
                ...
                >
                  <h3 className="font-sans text-[11px] sm:text-sm tracking-[0.3em] text-[#1B365D] font-bold uppercase mb-4 opacity-85">
                    Estás cordialmente invitado a la celebración de:
                  </h3>
                  <h2 className="font-great-vibes text-6xl sm:text-8xl text-[#1B365D] tracking-wide leading-none pb-2 mt-2 select-none">
                    Melissa & Jhimy
                  </h2>
                  <p className="font-serif text-[11px] sm:text-xs tracking-[0.2em] text-[#c5a059] font-bold uppercase mt-2">
                    Matrimonio • Bautizo & 1er Añito de Max Christian
                  </p>
                </motion.div>
              )}
